...
import { MODE_KEYS } from "@/lib/mode-keys";
...
const localizedWisdomThemes: Partial<Record<LanguageCode, Partial<Record<ThemeKey, string>>>> = {
  es: {
    [THEME_KEYS.STEWARDSHIP]: "Administración",
    [THEME_KEYS.DEBT]: "Deuda",
    [DEFAULT_TODAY_VISUAL_THEME]: "Contentamiento",
    [THEME_KEYS.COUNSEL]: "Consejo",
    [THEME_KEYS.COST_COUNTING]: "Cálculo del costo",
  ...
  pt: {
    [THEME_KEYS.STEWARDSHIP]: "Administração",
  ...
  yo: {
    [THEME_KEYS.STEWARDSHIP]: "Ìtọ́jú ohun tí a fi lé wa lọ́wọ́",
    [THEME_KEYS.DEBT]: "Gbèsè",
    [DEFAULT_TODAY_VISUAL_THEME]: "Ìtẹ́lọ́run",
    [THEME_KEYS.COUNSEL]: "Ìmọ̀ràn",
    [THEME_KEYS.COST_COUNTING]: "Kíka iye",
    [THEME_KEYS.GENEROSITY]: "Ìfẹ́ fúnni",
    [THEME_KEYS.DILIGENCE]: "Ìfarabalẹ̀ iṣẹ́",
    [THEME_KEYS.PROVISION_AND_ANXIETY]: "Ìpèsè àti àníyàn",
  ...
  de: {
    ...
    [THEME_KEYS.COST_COUNTING]: "Kosten prüfen",
    [THEME_KEYS.GENEROSITY]: "Großzügigkeit",
    [THEME_KEYS.DILIGENCE]: "Sorgfalt",
  ...
  tl: {
    [THEME_KEYS.STEWARDSHIP]: "Pangangasiwa",
    [THEME_KEYS.DEBT]: "Utang",
    [DEFAULT_TODAY_VISUAL_THEME]: "Kuntento",
    [THEME_KEYS.COUNSEL]: "Payo",
    [THEME_KEYS.COST_COUNTING]: "Pagtataya ng gastos",
    [THEME_KEYS.GENEROSITY]: "Pagkamapagbigay",
    [THEME_KEYS.DILIGENCE]: "Kasipagan",
  ...
  hi: {
    [THEME_KEYS.STEWARDSHIP]: "अमानत की देखभाल",
    [THEME_KEYS.DEBT]: "कर्ज़",
    [DEFAULT_TODAY_VISUAL_THEME]: "संतोष",
    [THEME_KEYS.COUNSEL]: "सलाह",
    [THEME_KEYS.COST_COUNTING]: "लागत का आकलन",
    [THEME_KEYS.GENEROSITY]: "उदारता",
    [THEME_KEYS.DILIGENCE]: "परिश्रम",
  ...
  en: {
    ...
    "Proverbs 21:5": {
      ...
      questions: [
        ...
        "Is this opportunity still wise after a night's rest?",
    ...
    "Matthew 6:25-34": {
      ...
      questions: [
        ...
        "Which concerns call for planning and which call for release?",
        "What would peace change in my pace?",
      ],
    },
  },
  es: {
...
const localizedModeLabels: Partial<Record<LanguageCode, Record<Mode, string>>> = {
  es: {
    [MODE_KEYS.MONEY]: "Dinero",
    [MODE_KEYS.WORK]: "Trabajo",
    [MODE_KEYS.PURPOSE]: "Propósito",
    [MODE_KEYS.GENEROSITY]: "Generosidad",
    [MODE_KEYS.LIFE]: "Vida",
  },
  fr: {
    [MODE_KEYS.MONEY]: "Argent",
    [MODE_KEYS.WORK]: "Travail",
    [MODE_KEYS.PURPOSE]: "But",
    [MODE_KEYS.GENEROSITY]: "Générosité",
    [MODE_KEYS.LIFE]: "Vie",
  },
  pt: {
    [MODE_KEYS.MONEY]: "Dinheiro",
    [MODE_KEYS.WORK]: "Trabalho",
    [MODE_KEYS.PURPOSE]: "Propósito",
    [MODE_KEYS.GENEROSITY]: "Generosidade",
    [MODE_KEYS.LIFE]: "Vida",
  },
  de: {
    [MODE_KEYS.MONEY]: "Geld",
    [MODE_KEYS.WORK]: "Arbeit",
    [MODE_KEYS.PURPOSE]: "Zweck",
    [MODE_KEYS.GENEROSITY]: "Großzügigkeit",
    [MODE_KEYS.LIFE]: "Leben",
  },
  yo: {
    [MODE_KEYS.MONEY]: "Owó",
    [MODE_KEYS.WORK]: "Iṣẹ́",
    [MODE_KEYS.PURPOSE]: "Ìdí",
    [MODE_KEYS.GENEROSITY]: "Ọ̀fẹ́",
    [MODE_KEYS.LIFE]: "Ayé",
  },
  ig: {
    [MODE_KEYS.MONEY]: "Ego",
    [MODE_KEYS.WORK]: "Ọrụ",
    [MODE_KEYS.PURPOSE]: "Nzube",
    [MODE_KEYS.GENEROSITY]: "Mmesapụ aka",
    [MODE_KEYS.LIFE]: "Ndụ",
  },
  ha: {
    [MODE_KEYS.MONEY]: "Kuɗi",
    [MODE_KEYS.WORK]: "Aiki",
    [MODE_KEYS.PURPOSE]: "Manufa",
    [MODE_KEYS.GENEROSITY]: "Karimci",
    [MODE_KEYS.LIFE]: "Rayuwa",
  },
  tl: {
    [MODE_KEYS.MONEY]: "Pera",
    [MODE_KEYS.WORK]: "Trabaho",
    [MODE_KEYS.PURPOSE]: "Layunin",
    [MODE_KEYS.GENEROSITY]: "Pagkamapagbigay",
    [MODE_KEYS.LIFE]: "Buhay",
  },
  ar: {
    [MODE_KEYS.MONEY]: "المال",
    [MODE_KEYS.WORK]: "العمل",
    [MODE_KEYS.PURPOSE]: "الغاية",
    [MODE_KEYS.GENEROSITY]: "الكرم",
    [MODE_KEYS.LIFE]: "الحياة",
  },
  hi: {
    [MODE_KEYS.MONEY]: "धन",
    [MODE_KEYS.WORK]: "काम",
    [MODE_KEYS.PURPOSE]: "उद्देश्य",
    [MODE_KEYS.GENEROSITY]: "उदारता",
    [MODE_KEYS.LIFE]: "जीवन",
  },
};
...
export type LocalizedWisdomEntry = Omit<WisdomEntryData, "theme"> & { theme: string };

export function localizedWisdomEntry(entry: WisdomEntryData, preferences: UserPreferences): LocalizedWisdomEntry {
...
export function localizedWisdomLibraryEntry(entry: WisdomEntryData, preferences: UserPreferences): LocalizedWisdomEntry {
  ...
  return {
    ...
    counselNotificationsEnabled:
      typeof input.counselNotificationsEnabled === "boolean"
        ...
        : defaultPreferences.counselNotificationsEnabled,
    formationNotificationsEnabled:
      typeof input.formationNotificationsEnabled === "boolean"
        ? input.formationNotificationsEnabled
        : defaultPreferences.formationNotificationsEnabled,
  };
}
